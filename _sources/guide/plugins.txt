...
The code sample above wraps a ``Zend_Log`` object using a ``Guzzle\Common\Log\ZendLogAdapter``. After attaching the plugin to the client, all data sent over the wire will be logged to stdout.
